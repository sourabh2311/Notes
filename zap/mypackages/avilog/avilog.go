...
func addCallToMsg(depth int, msg string) string {
	x := fmt.Sprintf("Caller at given (%v) level: ", depth)
	_, n, o, p := runtime.Caller(depth + 2)
	if p == false {
		_, n, o, p = runtime.Caller(2)
	}
	n = n + fmt.Sprintf(":%v ", o)
	x = x + n + "              " + msg
	return x
...
func (logger *AviLogger) Infow(msg string, keysAndValues ...interface{}) {
	logger.logger.Infow(addCallToMsg(0, msg), keysAndValues...)
}

func (logger *AviLogger) Warnw(msg string, keysAndValues ...interface{}) {
	logger.logger.Warnw(addCallToMsg(0, msg), keysAndValues...)
}

func (logger *AviLogger) Errorw(msg string, keysAndValues ...interface{}) {
	logger.logger.Errorw(addCallToMsg(0, msg), keysAndValues...)
}

func (logger *AviLogger) Fatalw(msg string, keysAndValues ...interface{}) {
	logger.logger.Fatalw(addCallToMsg(0, msg), keysAndValues...)
}

func (logger *AviLogger) InfowWithDepth(depth int, msg string, keysAndValues ...interface{}) {
	logger.logger.Infow(addCallToMsg(depth, msg), keysAndValues...)
}

func (logger *AviLogger) WarnwWithDepth(depth int, msg string, keysAndValues ...interface{}) {
	logger.logger.Warnw(addCallToMsg(depth, msg), keysAndValues...)
}

func (logger *AviLogger) ErrorwWithDepth(depth int, msg string, keysAndValues ...interface{}) {
	logger.logger.Errorw(addCallToMsg(depth, msg), keysAndValues...)
}

func (logger *AviLogger) FatalwWithDepth(depth int, msg string, keysAndValues ...interface{}) {
	logger.logger.Fatalw(addCallToMsg(depth, msg), keysAndValues...)
}
